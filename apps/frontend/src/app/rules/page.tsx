      ...
      <Card className='m-4'>
        <CardContent>
          ...
          <ol className='list-decimal list-inside mb-4 space-y-2'>
            ...
            <li>
              A teremfelszerelést a próba végeztével tedd a helyére, oda, és olyan állapotban, ahogy azt találtad, vagy
              a beengedővel megbeszélted. Ha a beengedő úgy találja, hogy a terem nincs rendben, kötelezhet téged az
              újbóli rendrakásra.
            </li>
            <li>
