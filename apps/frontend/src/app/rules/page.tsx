  ...
  return (
    <div className='w-full main-content-scroll h-full'>
      <div className='flex items-center justify-between flex-col sm:flex-row gap-2 p-4 bg-background sticky top-0 z-10'>
        <h1 className='text-2xl font-semibold text-primary text-center sm:text-left'>Próbaterem Szabályzat</h1>
      </div>
      <div className='mx-auto pb-8'>
        <Card className='m-4'>
          <CardHeader>
            <CardTitle>Általános tudnivalók</CardTitle>
          </CardHeader>
          <CardContent>
            <p className='mb-4'>
              A próbatermet csak olyan zenekarok használhatják, melyeknek van legalább egy volt vagy jelenlegi BME-s
              tagja.
            </p>
            <p>
        ...
        <Card className='m-4'>
          <CardHeader>
            <CardTitle>Próbaterem használatához szükséges teendők</CardTitle>
          </CardHeader>
          <CardContent>
            <ol className='list-decimal list-inside space-y-2'>
              ...
              <li>
                Töltsd ki a profilod. Ha korábban regisztráltál, ellenőrizd, hogy az elérhetőségeid még aktuálisak-e!
              </li>
              ...
              <li>
                ...
                teremispánnak egy e-mailt a banda nevével és a tagok felhasználóneveinek listájával, létrehozás után
        ...
        <Card className='m-4'>
          <CardHeader>
            <CardTitle>Bejutás a koliba</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className='m-4'>
          <CardHeader>
            <CardTitle>Próbarend</CardTitle>
          </CardHeader>
          <CardContent>
            <ol className='list-decimal list-inside space-y-2'>
              <li>
                Első próba alkalmával jelezd a beengedődnek, hogy mondja el a szükséges tudnivalókat a terem
                használatával kapcsolatban. Ezeket a beengedők bármikor szívesen elmondják újra, kérdezd őket bátran!
              </li>
              <li>
                Csak elfogadott jelentkezéssel rendelkező tagok használhatják a próbatermet. Ez alól még egy szám
                erejéig sem lehet kivételt tenni.
              </li>
              <li>
              ...
              <li>
                Egy héten összesen 6 óra, naponta pedig 3 óra foglalható fixen. Természetesen foglalhatsz többet is, de
              ...
              <li>
                A próba időpontjában a weben kiírt beengedőt kell keresni, hogy kinyissa a termet. A beengedő
                elérhetőségei szintén a honlapon találhatóak (szobaszám, mobilszám).
              </li>
              <li>
              ...
              <li>
                A teremfelszerelést a próba végeztével tedd a helyére, oda, és olyan állapotban, ahogy azt találtad,
                vagy a beengedővel megbeszélted. Ha a beengedő úgy találja, hogy a terem nincs rendben, kötelezhet téged
                az újbóli rendrakásra.
              </li>
              <li>
                Figyelj rá, hogy a terem pontban a foglalásod végeztével átadható állapotban legyen. Tapasztalatunk
                szerint egy bandának az összepakoláshoz kb. 15 perc szükséges.
              </li>
              <li>
                A termet a próba végeztével a beengedő jelenléte és jóváhagyása nélkül semmilyen esetben sem hagyhatod
                el.
              </li>
        ...
        <Card className='m-4'>
          ...
          <CardContent>
            ...
            <ul className='list-disc list-inside mb-4 space-y-2'>
              ...
              <li>
                Bekapcsolás előtt győződj meg róla, hogy a láda nem ér a falhoz, a csatlakoztatott kábel feje nem feszül
                a fal és a láda közé.
              </li>
            ...
            <ul className='list-disc list-inside space-y-2'>
              <li>
                Ezeket az eszközöket kizárólag a beengedők kezelhetik. A próbátok elején jelezzétek, ha szükségetek van
                rá.
              </li>
            </ul>
          </CardContent>
        </Card>
        <Card className='m-4' id='sanctions'>
          <CardHeader>
            <CardTitle>Szankciók</CardTitle>
          </CardHeader>
          <CardContent>
            <p className='mb-2'>
